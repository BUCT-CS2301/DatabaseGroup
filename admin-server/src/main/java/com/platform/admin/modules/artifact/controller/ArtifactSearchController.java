...
public class ArtifactSearchController {
    ...
    public Result<ArtifactSearchResultVO> searchArtifacts(
        ...
        return Result.success(artifactService.searchArtifacts(
                q,
                keyword,
                period,
                type,
    ...
    public Result<ArtifactFilterOptionsVO> getFilterOptions() {
        return Result.success(artifactService.getArtifactFilterOptions());
    }
}