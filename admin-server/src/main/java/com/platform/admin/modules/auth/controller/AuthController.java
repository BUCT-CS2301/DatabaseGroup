...
public class AuthController {
    ...
    public Result<Map<String, Object>> register(@RequestBody Map<String, String> request,
        ...
        data.put("avatar", publicUrlResolver.toPublicUrl(user.getAvatar(), httpRequest));
    ...
    public Result<Map<String, Object>> huaweiLogin(@RequestBody HuaweiLoginRequest request,
                                                   HttpServletRequest httpRequest) {
