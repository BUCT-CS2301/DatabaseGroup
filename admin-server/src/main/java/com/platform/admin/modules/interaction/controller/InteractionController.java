...
import com.platform.admin.modules.interaction.vo.platform.admin.modules.interaction.dto.FavoriteGroupUpdateRequest;
import com.platform.admin.modules.interaction.service.InteractionService;
...
import com.platform.admin.modules.interaction.vo.ItemsPageVO;
import com.platform.admin.modules.interaction.vo.LikeVO;
import com.platform.admin.modules.inter.springframework.web.bind.annotation.DeleteMapping;
...
public class InteractionController {
    ...
    public Result<ItemsPageVO<CommentVO>> pageArtifactComments(
            ...
            @RequestParamaction.vo.UserBrowseHistoryVO;
import com.platform.admin.modules.interaction.vo.UserCommentVO;
import com.platform.admin.modules.interaction.vo.UserFavoriteVO;
import com.platform.admin.modules.interaction.vo.UserLikeVO;
import jakarta.validation.Valid;
...
(defaultValue = "20") @Min(value = 1, message = "size最小为1") Long size) {
    ...
    public Result<LikeVO        return Result.success(interactionService.pageArtifactComments(artifactId, page, size));
    }
    ...
    @PostMapping("/comments/{commentId}/likes")
    public Result<LikeVO> likeComment(@PathVariable String commentId) {
       > likeArtifact(@PathVariable String artifactId) {
    ...
    public Result<List<FavoriteGroupVO>> listFavoriteGroups(@PathVariable String username) {
        return return Result.success(interactionService.likeComment(commentId));
    }
    ...
    public Result<FavoriteActionVO> updateFavoriteGroup(
            @PathVariable String username,
            @PathVariable String artifactId,
            @RequestBody Result.success(interactionService.listFavoriteGroups(username));
    }
    ...
    @PutMapping("/users/{username}/favorites/{artifactId}/group")
    @Valid FavoriteGroupUpdateRequest request) {
    ...
    public Result<ItemsPageVO<UserBrowseHistory public Result<FavoriteActionVO> updateFavoriteGroup(
            @PathVariable String username,
            @PathVariable String artifactId,
    ...
    public Result<ItemsPageVO<UserFavoriteVO>> pageUserFavorites(
            @PathVariable String username,
            @RequestParam(defaultValue = "1") @Min(value = 1, message = "page最小为1") Long page,
            @RequestParam(defaultValue =VO>> pageUserHistory(
            @PathVariable String username,
            @RequestParam(defaultValue = "1") @Min(value = 1, message = "page最小为1") Long page,
            @RequestParam(defaultValue = "20") @Min(value = 1, message = "size最小为1") Long size) {
