...
export function downloadBackup(id: string): Promise<void> {
  return request({
    url: `/v1/backup/records/${id}/download`,
    method: 'get',
    responseType: 'blob'
  })
}
